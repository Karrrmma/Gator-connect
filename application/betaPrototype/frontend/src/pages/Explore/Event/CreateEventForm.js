...
function CreateEventForm({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setConfirmation(
        data.message || 'New event created! Refresh page to see it displayed.'
      );
                  ...
                  <form className="form-box" onSubmit={handleSubmit}>
                    <div className="create-event">
                      ...
                      >
                        ...
                        <option value="Cesar Chavez Building">
                        ...
                        <option value="Business Building">
                          Business Building
                        </option>
                        ...
                        <option value="Fine Arts Building">
                          Fine Arts Building
                        </option>
                      </select>
