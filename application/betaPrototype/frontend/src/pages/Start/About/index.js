    ...
    <div className="form-container">
      <div className="form-wrapper about-wrapper mt-5">
        ...
        <div className="description">
          <p>
            Hello! We are Team 3 also known as Thream. <br></br> We were put
            together in CSC 648-05 to work in a Software Engineering
            environment.
          </p>
        </div>
        <img src={AboutPicture} className="team-img"></img>{' '}
        {/* This is formatted for a group picture right now, change later as needed */}
