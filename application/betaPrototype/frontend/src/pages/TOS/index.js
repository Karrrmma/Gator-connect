...
function TOS() {
  return (
    <div className="form-container mt-5">
      <div className="form-wrapper mt-5 text-left tos-wrapper">
        <h1 className="text-center">Terms of Service</h1>
        <h2>Last updated May 07, 2024</h2>
        <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
        <p>
          We are Thream ("Company," "we," "us," "our"), a company registered in
          California, United States at 1600 Holloway Ave, San Francisco, CA
          94132.
        </p>
        <p>
          We operate the website LINK_PLACEHOLDER (the "Site"), as well as any
          other related products and services that refer or link to these legal
          terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>We are a social media platform for SFSU students.</p>
        <p>
          You can contact us by phone at PHONE_PLACEHOLDER, email at
          EMAIL_PLACEHOLDER, or by mail to 1600 Holloway Ave, San Francisco, CA
          94132, United States.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and Thream,
        ...
        <p>
          ...
          to a court order, security updates, and bug fixes, in which case the
        ...
        <br />
        <p className="text-subtitle">TABLE OF CONTENTS</p>
        <br />
        <p>1. OUR SERVICES</p>
        ...
        <p>25. CONTACT US</p>
        <br />
        <p className="text-subtitle">1. OUR SERVICES</p>
        <br />
        <p>
        ...
        <br />
        <p className="text-subtitle">2. INTELLECTUAL PROPERTY RIGHTS</p>
        <br />
        <p className="text-subsubtitle">Our intellectual property</p>
        <br />
        <p>
        ...
        <br />
        <p className="text-subsubtitle">Your use of our Services</p>
        <br />
        <p>
        ...
        <p>
          ...
          please address your request to: EMAIL_PLACEHOLDER. If we ever grant
        ...
        <br />
        <p className="text-subsubtitle">Your submissions and contributions</p>
        <br />
        <p>
        ...
        <p>
          ...
          partyâ€™s intellectual property rights, or (c) applicable law.
        </p>
        <br />
        <p>
        ...
        <br />
        <p className="text-subsubtitle">Copyright infringement</p>
        <br />
        <p>
        ...
        <p>
          ...
          interchange formats ("gifs"), 1Ã—1 pixels, web bugs, cookies, or other
        ...
        <p>
          ...
          Policy: LINK_PLACEHOLDER/privacy. By using the Services, you agree to
          ...
          Childrenâ€™s Online Privacy Protection Act, if we receive actual
        ...
        <p>
          ...
          and federal courts located in San Francisco, California, and the
