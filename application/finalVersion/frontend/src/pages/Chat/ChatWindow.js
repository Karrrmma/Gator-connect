...
const ChatWindow = () => {
  ...
  useEffect(() => {
    ...
    fetchPrivateMessages(senderID, name)
      .then((res) => {
              ...
              <div>
                <p
                  style={{
                    ...
                    fontSize: '10px',
                    marginLeft:
                      priv_message.sender_id === getCurrentUserId()
                        ? 'auto'
                        : '0',
                    border: '#252525',
                    textAlign: 'center',
  ...
  return (
    <p
      style={{
        ...
        color: 'white',
        maxWidth: '50%',
        marginLeft: userID === getCurrentUserId() ? 'auto' : '0',
        fontSize: '10px',
        border: '#252525',
        marginBottom: 'auto',
        textAlign: userID === getCurrentUserId() ? 'right' : 'left',
      }}
    >
      {userData.fullName}
    </p>
  ...
  return (
    <div className="head-chat">
      <div
        ...
        style={{ width: '100%', padding: '20px', textAlign: 'right' }}
      >
        {/* <div className="avatar" style={{fontSize: '30px'}}>{avatar}</div> */}
        <p style={{ color: 'white', fontSize: '25px', marginLeft: '5px' }}>
          {name}
        </p>
        <Link
          to="/chat"
...
function Bottom({ inputMessage, setInputMessage, sendMessage }) {
  ...
  return (
    <div className="w-100 mb-4">
      <div
        className="chat-body d-flex align-items-center"
        style={{ background: 'black', justifyContent: 'center' }}
      >
        <input
          type="text rounded-pill"
