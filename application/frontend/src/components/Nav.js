...
function Nav() {
    return (
        <nav class="navbar navbar-expand-lg navbar-dark top w-100 sticky-top" style={{ backgroundColor: 'black' }}>
            ...
            <Link className="nav-item nav-link d-inline-block mr-auto" style={{ fontSize: '1.5rem' }}>GATOR CONNECT</Link>
            ...
            <Link to='/' className="nav-item nav-link d-lg-inline-block ml-auto" style={{ fontSize: '1.5rem' }}>Log Out</Link>
        </nav>
    );
}
