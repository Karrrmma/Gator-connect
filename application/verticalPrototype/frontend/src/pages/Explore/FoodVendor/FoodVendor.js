    ...
    <div className="content-wrapper">
      ...
      <div className="search-wrapper">
        ...
        <p style={{ color: '#D3D3D3', fontSize: '14px', margin: '0', textAlign: 'left' }}>
          Explore the diverse dining options available at San Francisco State University.  
          Discover a world of flavors right here at SFSU with our selection of food vendors.  
          From quick bites to fine dining, see what SFSU has to offer in terms of food and beverages.  
          Browse through our comprehensive list of vendors.
        </p>
